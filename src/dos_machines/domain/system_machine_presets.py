...
SYSTEM_MACHINE_PRESETS: list[MachinePreset] = [
    MachinePreset(
        ...
        sections={
            "cpu": {"core": "normal", "cycles": "315"},
            "dosbox": {"machine": "cga"},
            "speaker": {"pcspeaker": "true", "tandy": "off", "disney": "false"},
            "sblaster": {"sbtype": "none"},
            "gus": {"gus": "false"},
            "midi": {"mpu401": "none", "mididevice": "none"},
    ...
    MachinePreset(
        ...
        sections={
            "cpu": {"core": "normal", "cycles": "315"},
            "dosbox": {"machine": "pcjr"},
            "speaker": {"pcspeaker": "true", "tandy": "auto", "disney": "false"},
            "sblaster": {"sbtype": "none"},
            "gus": {"gus": "false"},
            "midi": {"mpu401": "none", "mididevice": "none"},
    ...
    MachinePreset(
        ...
        sections={
            ...
            "speaker": {"pcspeaker": "true", "tandy": "on", "disney": "false"},
            "sblaster": {"sbtype": "none"},
            "gus": {"gus": "false"},
            "midi": {"mpu401": "none", "mididevice": "none"},
            "joystick": {"joysticktype": "2axis"},
    ...
    MachinePreset(
        ...
        sections={
            ...
            "gus": {"gus": "false"},
            "midi": {"mpu401": "uart", "mididevice": "default"},
